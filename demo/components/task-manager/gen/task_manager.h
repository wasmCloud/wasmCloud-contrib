...
typedef struct wasmcloud_task_manager_types_operation_t {
  ...
  task_manager_string_t   category;
  task_manager_string_t   payload;
  task_manager_string_t   created_at;
  task_manager_option_string_t   completed_at;
  task_manager_option_string_t   failure;
  task_manager_option_string_t   result;
...
void exports_wasmcloud_task_manager_tracker_start(task_manager_string_t *category, task_manager_string_t *payload, exports_wasmcloud_task_manager_tracker_result_string_operation_error_t *ret);
...
void exports_wasmcloud_task_manager_tracker_complete(task_manager_string_t *id, task_manager_string_t *outcome, exports_wasmcloud_task_manager_tracker_result_void_operation_error_t *ret);
void exports_wasmcloud_task_manager_tracker_fail(task_manager_string_t *id, task_manager_string_t *outcome, exports_wasmcloud_task_manager_tracker_result_void_operation_error_t *ret);
void exports_wasmcloud_task_manager_tracker_list(task_manager_option_string_t *filter, exports_wasmcloud_task_manager_tracker_result_list_operation_operation_error_t *ret);
