...
#ifndef __BINDINGS_TASK_MANAGER_H
#define __BINDINGS_TASK_MANAGER_H
#ifdef __cplusplus
extern "C" {
#endif
...
typedef struct task_manager_string_t {
  uint8_t*ptr;
  size_t len;
} task_manager_string_t;
...
typedef struct wasmcloud_postgres_types_query_error_t {
  uint8_t tag;
  union {
    task_manager_string_t     invalid_params;
    task_manager_string_t     invalid_query;
    task_manager_string_t     unexpected;
  } val;
...
typedef task_manager_string_t wasmcloud_postgres_types_ipv4_addr_t;

typedef task_manager_string_t wasmcloud_postgres_types_ipv6_addr_t;

typedef task_manager_string_t wasmcloud_postgres_types_subnet_t;
...
typedef task_manager_string_t wasmcloud_postgres_types_column_name_t;

// Arbitrary precision numeric type
typedef task_manager_string_t wasmcloud_postgres_types_numeric_t;
...
typedef struct {
  ...
  uint32_t f1;
  uint32_t f2;
} task_manager_tuple3_s32_u32_u32_t;
...
typedef struct wasmcloud_postgres_types_date_t {
  uint8_t tag;
  union {
    task_manager_tuple3_s32_u32_u32_t     ymd;
  } val;
...
typedef struct wasmcloud_postgres_types_time_tz_t {
  task_manager_string_t   timesonze;
...
typedef struct {
  ...
  uint8_t f4;
  uint8_t f5;
} task_manager_tuple6_u8_u8_u8_u8_u8_u8_t;

typedef struct wasmcloud_postgres_types_mac_address_eui48_t {
  task_manager_tuple6_u8_u8_u8_u8_u8_u8_t   bytes;
...
typedef struct {
  ...
  uint8_t f6;
  uint8_t f7;
} task_manager_tuple8_u8_u8_u8_u8_u8_u8_u8_u8_t;

typedef struct wasmcloud_postgres_types_mac_address_eui64_t {
  task_manager_tuple8_u8_u8_u8_u8_u8_u8_u8_u8_t   bytes;
} wasmcloud_postgres_types_mac_address_eui64_t;

typedef struct {
  int64_t *ptr;
  size_t len;
} task_manager_list_s64_t;

typedef struct {
  bool *ptr;
  size_t len;
} task_manager_list_bool_t;

typedef struct {
  wasmcloud_postgres_types_hashable_f64_t *ptr;
  size_t len;
} task_manager_list_hashable_f64_t;

typedef struct {
  wasmcloud_postgres_types_hashable_f32_t *ptr;
  size_t len;
} task_manager_list_hashable_f32_t;

typedef struct {
  int32_t *ptr;
  size_t len;
} task_manager_list_s32_t;

typedef struct {
  wasmcloud_postgres_types_numeric_t *ptr;
  size_t len;
} task_manager_list_numeric_t;

typedef struct {
  int16_t *ptr;
  size_t len;
} task_manager_list_s16_t;

typedef struct {
  task_manager_list_s16_t *ptr;
  size_t len;
} task_manager_list_list_s16_t;

typedef struct {
  uint8_t *ptr;
  size_t len;
} task_manager_list_u8_t;

typedef struct {
  uint32_t f0;
  task_manager_list_u8_t f1;
} task_manager_tuple2_u32_list_u8_t;

typedef struct {
  task_manager_tuple2_u32_list_u8_t *ptr;
  size_t len;
} task_manager_list_tuple2_u32_list_u8_t;

typedef struct {
  bool is_some;
  uint32_t val;
} task_manager_option_u32_t;

typedef struct {
  task_manager_option_u32_t f0;
  task_manager_list_u8_t f1;
} task_manager_tuple2_option_u32_list_u8_t;

typedef struct {
  task_manager_tuple2_option_u32_list_u8_t *ptr;
  size_t len;
} task_manager_list_tuple2_option_u32_list_u8_t;

typedef struct {
  task_manager_list_u8_t *ptr;
  size_t len;
} task_manager_list_list_u8_t;

typedef struct {
  task_manager_string_t *ptr;
  size_t len;
} task_manager_list_string_t;
...
} task_manager_tuple2_lower_left_point_upper_right_point_t;

typedef struct {
  task_manager_tuple2_lower_left_point_upper_right_point_t *ptr;
  size_t len;
} task_manager_list_tuple2_lower_left_point_upper_right_point_t;

typedef struct {
  wasmcloud_postgres_types_center_point_t f0;
  wasmcloud_postgres_types_radius_t f1;
} task_manager_tuple2_center_point_radius_t;

typedef struct {
  task_manager_tuple2_center_point_radius_t *ptr;
  size_t len;
} task_manager_list_tuple2_center_point_radius_t;

typedef struct {
  wasmcloud_postgres_types_start_point_t f0;
  wasmcloud_postgres_types_end_point_t f1;
} task_manager_tuple2_start_point_end_point_t;

typedef struct {
  task_manager_tuple2_start_point_end_point_t *ptr;
  size_t len;
} task_manager_list_tuple2_start_point_end_point_t;

typedef struct {
  wasmcloud_postgres_types_point_t *ptr;
  size_t len;
} task_manager_list_point_t;

typedef struct {
  task_manager_list_point_t *ptr;
  size_t len;
} task_manager_list_list_point_t;
...
typedef struct {
  bool is_some;
  task_manager_string_t val;
} task_manager_option_string_t;

typedef struct {
  task_manager_string_t f0;
  task_manager_option_string_t f1;
} task_manager_tuple2_string_option_string_t;

typedef struct {
  task_manager_tuple2_string_option_string_t *ptr;
  size_t len;
} task_manager_list_tuple2_string_option_string_t;
...
typedef struct wasmcloud_postgres_types_pg_value_t {
  ...
  union {
    int64_t     big_int;
    int64_t     int8;
    task_manager_list_s64_t     int8_array;
    int64_t     big_serial;
    int64_t     serial8;
    bool     bool_;
    bool     boolean;
    task_manager_list_bool_t     bool_array;
    wasmcloud_postgres_types_hashable_f64_t     double_;
    wasmcloud_postgres_types_hashable_f64_t     float8;
    task_manager_list_hashable_f64_t     float8_array;
    wasmcloud_postgres_types_hashable_f32_t     real;
    wasmcloud_postgres_types_hashable_f32_t     float4;
    task_manager_list_hashable_f32_t     float4_array;
    int32_t     integer;
    int32_t     int_;
    int32_t     int4;
    task_manager_list_s32_t     int4_array;
    wasmcloud_postgres_types_numeric_t     numeric;
    wasmcloud_postgres_types_numeric_t     decimal;
    task_manager_list_numeric_t     numeric_array;
    uint32_t     serial;
    uint32_t     serial4;
    int16_t     small_int;
    int16_t     int2;
    task_manager_list_s16_t     int2_array;
    task_manager_list_s16_t     int2_vector;
    task_manager_list_list_s16_t     int2_vector_array;
    int16_t     small_serial;
    int16_t     serial2;
    task_manager_tuple2_u32_list_u8_t     bit;
    task_manager_list_tuple2_u32_list_u8_t     bit_array;
    task_manager_tuple2_option_u32_list_u8_t     bit_varying;
    task_manager_tuple2_option_u32_list_u8_t     varbit;
    task_manager_list_tuple2_option_u32_list_u8_t     varbit_array;
    task_manager_list_u8_t     bytea;
    task_manager_list_list_u8_t     bytea_array;
    task_manager_tuple2_u32_list_u8_t     char_;
    task_manager_list_tuple2_u32_list_u8_t     char_array;
    task_manager_tuple2_option_u32_list_u8_t     varchar;
    task_manager_list_tuple2_option_u32_list_u8_t     varchar_array;
    task_manager_string_t     cidr;
    task_manager_list_string_t     cidr_array;
    task_manager_string_t     inet;
    task_manager_list_string_t     inet_array;
    ...
    task_manager_tuple2_lower_left_point_upper_right_point_t     box;
    task_manager_list_tuple2_lower_left_point_upper_right_point_t     box_array;
    task_manager_tuple2_center_point_radius_t     circle;
    task_manager_list_tuple2_center_point_radius_t     circle_array;
    task_manager_tuple2_start_point_end_point_t     line;
    task_manager_list_tuple2_start_point_end_point_t     line_array;
    task_manager_tuple2_start_point_end_point_t     lseg;
    task_manager_list_tuple2_start_point_end_point_t     lseg_array;
    task_manager_list_point_t     path;
    task_manager_list_list_point_t     path_array;
    wasmcloud_postgres_types_point_t     point;
    task_manager_list_point_t     point_array;
    task_manager_list_point_t     polygon;
    task_manager_list_list_point_t     polygon_array;
    wasmcloud_postgres_types_date_t     date;
    ...
    task_manager_string_t     json;
    task_manager_list_string_t     json_array;
    task_manager_string_t     jsonb;
    task_manager_list_string_t     jsonb_array;
    wasmcloud_postgres_types_numeric_t     money;
    task_manager_list_numeric_t     money_array;
    uint64_t     pg_lsn;
    task_manager_list_u64_t     pg_lsn_array;
    task_manager_tuple3_xmin_xmax_xip_list_t     pg_snapshot;
    int64_t     txid_snapshot;
    task_manager_string_t     name;
    task_manager_list_string_t     name_array;
    task_manager_string_t     text;
    task_manager_list_string_t     text_array;
    task_manager_string_t     xml;
    task_manager_list_string_t     xml_array;
    task_manager_string_t     ts_query;
    wasmcloud_postgres_types_list_lexeme_t     ts_vector;
    task_manager_string_t     uuid;
    task_manager_list_string_t     uuid_array;
    task_manager_list_tuple2_string_option_string_t     hstore;
  } val;
...
typedef struct wasmcloud_postgres_types_result_row_entry_t {
  ...
  task_manager_string_t   column_name;
...
typedef wasmcloud_postgres_types_pg_value_t wasmcloud_postgres_prepared_pg_value_t;

typedef wasmcloud_postgres_types_result_row_t wasmcloud_postgres_prepared_result_row_t;

typedef wasmcloud_postgres_types_statement_prepare_error_t wasmcloud_postgres_prepared_statement_prepare_error_t;

typedef wasmcloud_postgres_types_prepared_statement_exec_error_t wasmcloud_postgres_prepared_prepared_statement_exec_error_t;

// A token that represents a previously created prepared statement,
// 
// This token can be expected to be somewhat opaque to users.
typedef task_manager_string_t wasmcloud_postgres_prepared_prepared_statement_token_t;

typedef struct {
  bool is_err;
  union {
    wasmcloud_postgres_prepared_prepared_statement_token_t ok;
    wasmcloud_postgres_prepared_statement_prepare_error_t err;
  } val;
} wasmcloud_postgres_prepared_result_prepared_statement_token_statement_prepare_error_t;

typedef struct {
  wasmcloud_postgres_prepared_pg_value_t *ptr;
  size_t len;
} wasmcloud_postgres_prepared_list_pg_value_t;

typedef struct {
  bool is_err;
  union {
    uint64_t ok;
    wasmcloud_postgres_prepared_prepared_statement_exec_error_t err;
  } val;
} wasmcloud_postgres_prepared_result_u64_prepared_statement_exec_error_t;

typedef struct wasmcloud_task_manager_types_operation_error_t {
  task_manager_string_t   message;
} wasmcloud_task_manager_types_operation_error_t;

typedef struct {
  bool is_some;
  bool val;
} task_manager_option_bool_t;

typedef struct wasmcloud_task_manager_types_operation_t {
  task_manager_string_t   id;
  task_manager_string_t   original_asset;
  task_manager_string_t   created_at;
  task_manager_option_string_t   resized_asset;
  task_manager_option_string_t   resize_error;
  task_manager_option_string_t   resized_at;
  task_manager_option_bool_t   analyze_result;
  task_manager_option_string_t   analyze_error;
  task_manager_option_string_t   analyzed_at;
} wasmcloud_task_manager_types_operation_t;

typedef wasmcloud_task_manager_types_operation_t exports_wasmcloud_task_manager_tracker_operation_t;

typedef wasmcloud_task_manager_types_operation_error_t exports_wasmcloud_task_manager_tracker_operation_error_t;

typedef struct {
  bool is_err;
  union {
    task_manager_string_t ok;
    exports_wasmcloud_task_manager_tracker_operation_error_t err;
  } val;
} exports_wasmcloud_task_manager_tracker_result_string_operation_error_t;

typedef struct {
  bool is_err;
  union {
    exports_wasmcloud_task_manager_tracker_operation_t ok;
    exports_wasmcloud_task_manager_tracker_operation_error_t err;
  } val;
} exports_wasmcloud_task_manager_tracker_result_operation_operation_error_t;
...
} exports_wasmcloud_task_manager_tracker_result_void_operation_error_t;

typedef struct {
  exports_wasmcloud_task_manager_tracker_operation_t *ptr;
  size_t len;
} exports_wasmcloud_task_manager_tracker_list_operation_t;

typedef struct {
  bool is_err;
  union {
    exports_wasmcloud_task_manager_tracker_list_operation_t ok;
    exports_wasmcloud_task_manager_tracker_operation_error_t err;
  } val;
} exports_wasmcloud_task_manager_tracker_result_list_operation_operation_error_t;
...
// text.
extern void wasi_logging_logging_log(wasi_logging_logging_level_t level, task_manager_string_t *context, task_manager_string_t *message);
...
// ```
extern void wasmcloud_postgres_query_query(task_manager_string_t *query, wasmcloud_postgres_query_list_pg_value_t *params, wasmcloud_postgres_query_result_list_result_row_query_error_t *ret);
...
extern void wasmcloud_postgres_prepared_prepare(task_manager_string_t *statement, wasmcloud_postgres_prepared_result_prepared_statement_token_statement_prepare_error_t *ret);
// Execute a prepared statement, returning the number of rows affected
extern void wasmcloud_postgres_prepared_exec(wasmcloud_postgres_prepared_prepared_statement_token_t *stmt_token, wasmcloud_postgres_prepared_list_pg_value_t *params, wasmcloud_postgres_prepared_result_u64_prepared_statement_exec_error_t *ret);

// Exported Functions from `wasmcloud:task-manager/tracker`
void exports_wasmcloud_task_manager_tracker_start(task_manager_string_t *original_asset, exports_wasmcloud_task_manager_tracker_result_string_operation_error_t *ret);
void exports_wasmcloud_task_manager_tracker_get(task_manager_string_t *id, exports_wasmcloud_task_manager_tracker_result_operation_operation_error_t *ret);
void exports_wasmcloud_task_manager_tracker_complete_resize(task_manager_string_t *id, task_manager_option_string_t *resized_asset, task_manager_option_string_t *resize_error, exports_wasmcloud_task_manager_tracker_result_void_operation_error_t *ret);
void exports_wasmcloud_task_manager_tracker_complete_analyze(task_manager_string_t *id, task_manager_option_bool_t *detected, task_manager_option_string_t *analyze_error, exports_wasmcloud_task_manager_tracker_result_void_operation_error_t *ret);
void exports_wasmcloud_task_manager_tracker_list(exports_wasmcloud_task_manager_tracker_result_list_operation_operation_error_t *ret);
void exports_wasmcloud_task_manager_tracker_delete(task_manager_string_t *id, exports_wasmcloud_task_manager_tracker_result_void_operation_error_t *ret);
