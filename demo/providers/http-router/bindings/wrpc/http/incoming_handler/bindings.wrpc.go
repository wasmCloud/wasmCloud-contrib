...
import (
	...
	errors "errors"
	fmt "fmt"
	wasi__http__types "github.com/wasmCloud/wasmcloud-contrib/demo/providers/http-router/bindings/wasi/http/types"
	wrpc__http__types "github.com/wasmCloud/wasmcloud-contrib/demo/providers/http-router/bindings/wrpc/http/types"
...
func Handle(ctx__ context.Context, wrpc__ wrpc.Invoker, request *wrpc__http__types.Request) (r0__ *wrpc.Result[Response, ErrorCode], close__ func() error, err__ error) {
	if err__ = wrpc__.Invoke(ctx__, "wrpc:http/incoming-handler@0.1.0", "handle", func(w__ wrpc.IndexWriter, r__ wrpc.IndexReadCloser) error {
		close__ = r__.Close
